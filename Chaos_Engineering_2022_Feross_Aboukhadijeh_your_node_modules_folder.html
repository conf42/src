  ...
  <head>
    ...
    <script>
      ...
      function updateCountry() {
        selectElement = document.querySelector('#country-source');
        output = selectElement.value;
        document.querySelector('#country-destination').value = output;
      }
    </script>
              ...
              <div class="dropdown-menu dropdown-menu-xl p-0" aria-labelledby="navbarLandings">
                <div class="row gx-0">
                  <div class="col-12 col-lg-6">
                    <!-- <div class="dropdown-img-start" style="background-image: url(./assets/splash/JS2023_Event_Splash.png);"> -->
                    <div class="dropdown-img-start">
                      ...
                      <!-- Button -->
                      <a href="https://www.conf42.com/js2023" class="btn btn-sm btn-white shadow-dark fonFt-size-sm">
                        Learn more
                      </a>
                    </div>
                  </div>
